...
//         return(
//           <MenuItem key={index}
//           value={value.Category} >{value.Cname}</MenuItem>
//         )
//       })
//     }
//   </Select>
// </FormControl><br/><br/>
//     <Button variant="contained" onChange={addHandler} >Submit</Button>
//     </div>
//   )
// }
...
const Subcategory = () => {
  ...
  <Select
   labelId="demo-simple-select-label"
    name='Cname'value={inputs.Cname} onChange={inputHandler}>
    {
      ca.map((value,index)=>{
        return(
          <MenuItem key={index}
